...
export default function CreateFeatureModal({ isOpen, onClose, onCreated, projectId }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Failed to submit feature request');
    } finally {
      setSubmitting(false);
    }
  };
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-xs">
      <div className="bg-white rounded-xl border border-slate-200 shadow-xl max-w-lg w-full overflow-hidden">
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
          <h2 className="text-lg font-bold text-slate-900">Suggest a Feature</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="e.g., Dark mode support or Export to CSV"
          ...
          <div>
            ...
            {activeTab === 'write' ? (
              <textarea
                ...
                placeholder="Explain what problem this solves and how it should work. You can use markdown like **bold**, `code`, or bullet lists."
